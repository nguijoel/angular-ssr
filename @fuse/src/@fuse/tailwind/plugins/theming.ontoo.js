...
const theming = plugin.withOptions((options) => ({
    ...
    }) =>
    {
        ...
        /* Get the file path */
        const filename =   options.filename || path.resolve(__dirname, ('../../styles/user-themes.scss'));
                    ...
                    customProps: {
                        background: {
                            light: {
                                'bg-app-bar'   : '#FFFFFF',
                                'bg-card'      : '#FFFFFF',
                                'bg-default'   : options.bgDefaultLight || colors.slate[100],
                                'bg-dialog'    : '#FFFFFF',
                            ...
                            dark : {
                                ...
                                'bg-default'   : options.bgDefaultDark || colors.slate[900],
